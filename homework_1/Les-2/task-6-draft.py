...
Задание не делал, смог тольок разобрать решение
"""

product_template = {  # шаблон словаря
...
next_enter = True # условия работы цикла  while

auto_inc = 1 #  порядковый номер в products_list
products_list = [] # список состоящий из словарей по по шаблону стр 26
